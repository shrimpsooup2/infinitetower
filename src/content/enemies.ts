...
const BOSSES: EnemyDef[] = [
  ...
  E({ id: 'hexacosi', name: 'The 600-Cell', dim: 4, n: 600, poly: 'cell600', color: '#bf7ff5', hp: 26000, shield: 4000, armor: 12, speed: 0.4, bounty: 700, lives: 20, size: 0.95, cost: 0, intro: 0,
...
const STRANGE_BOSSES: EnemyDef[] = [
  ...
  E({ id: 'grand_antiprism', name: 'The Grand Antiprism', dim: 4, n: 320, poly: 'grand_antiprism', color: '#b0a0ff', hp: 46000, shield: 10400, speed: 0.42, bounty: 720, lives: 20, size: 0.95, cost: 0, intro: 0,
    tenacity: 0.3, traits: ['boss', 'shielded'],
