...
export const MAPS: MapDef[] = [
  ...
  {
    id: 'meadow', name: 'Meadow', blurb: 'A gentle serpentine.', act: 1, waves: 20, theme: 'plain',
  ...
  {
    id: 'switchback', name: 'Switchback', blurb: 'A long zig-zag.', act: 1, waves: 20, theme: 'plain',
  ...
  {
    id: 'crossroads', name: 'Crossroads', blurb: 'Two spawns merge into one road.', act: 1, waves: 20, theme: 'paper',
  ...
  {
    id: 'loopback', name: 'Loopback', blurb: 'The road crosses itself.', act: 1, waves: 20, theme: 'paper',
  ...
  {
    id: 'orchard', name: 'Orchard', blurb: 'Two lanes join among the trees.', act: 1, waves: 20, theme: 'garden',
  ...
  {
    id: 'skyway', name: 'Skyway', blurb: 'Heavy air traffic over a winding road.', act: 2, waves: 40, theme: 'blueprint',
  ...
  {
    id: 'fork', name: 'Fork', blurb: 'The road splits and rejoins.', act: 2, waves: 40, theme: 'blueprint',
  ...
  {
    id: 'dunes', name: 'Dunes', blurb: 'A long road through the sand.', act: 2, waves: 40, theme: 'desert',
  ...
  {
    id: 'spiral', name: 'Spiral', blurb: 'The road winds in to a base at the heart.', act: 2, waves: 40, theme: 'crystal',
  ...
  {
    id: 'geode', name: 'Geode', blurb: 'Two roads meet inside the crystal.', act: 2, waves: 40, theme: 'crystal',
  ...
  {
    id: 'twinrivers', name: 'Twin Rivers', blurb: 'Two roads, two exits.', act: 3, waves: 60, theme: 'neon',
  ...
  {
    id: 'gauntlet', name: 'Gauntlet', blurb: 'A short road through the pillars.', act: 3, waves: 60, theme: 'neon',
  ...
  {
    id: 'nebula', name: 'Nebula', blurb: 'An S through the clouds, with two sky lanes.', act: 3, waves: 60, theme: 'void',
  ...
  {
    id: 'horizon', name: 'Event Horizon', blurb: 'A long comb of a road.', act: 3, waves: 60, theme: 'void',
    cols: 30, rows: 17, seed: 828, difficulty: 5, hpScale: 1.0, pathMode: 'first',
  ...
  {
    id: 'tesseract', name: 'Tesseract', blurb: 'A road that folds back through itself.', act: 3, waves: 60, theme: 'hyper',
