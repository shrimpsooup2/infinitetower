...
const BOSSES: EnemyDef[] = [
  ...
  E({ id: 'sphere', name: 'The Sphere', dim: 3, n: 0, poly: 'sphere', color: '#ffffff', hp: 19500, shield: 4400, speed: 0.45, bounty: 500, lives: 20, size: 0.95, cost: 0, intro: 0,
...
const STRANGE_BOSSES: EnemyDef[] = [
  ...
  E({ id: 'gsd', name: 'The Great Stellated Dodecahedron', dim: 3, n: 12, poly: 'great_stellated_dodecahedron', color: '#ffcf40', hp: 16000, shield: 2000, armor: 8, speed: 0.42, bounty: 360, lives: 15, size: 0.85, cost: 0, intro: 0,
