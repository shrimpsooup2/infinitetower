...
Map: 24x14 tiles. Enemies walk a path at 0.4 to 2 tiles/s. Tower ranges: 2.2 (Flame) to 8.6 (Mortar) tiles. Towers attack 0.4 to 5 times per second. A wave lasts 20 to 60 s; 40 waves per run. Enemy types: swarms of tiny triangles, fast crashers, armored pentagons (armor blocks kinetic damage), flying kites (Cannon, Mortar and Flame cannot hit them), shielded hexagons (shields regenerate; shock does double to shields), healers, splitters, blinkers, stealthy shades (must be revealed or marked), burrowers, necromancers, and bosses that resist crowd control.
