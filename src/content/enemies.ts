...
const STRANGE_BOSSES: EnemyDef[] = [
  ...
  E({ id: 'cell120', name: 'The 120-Cell', dim: 4, n: 120, poly: 'cell120', color: '#8ef0c4', hp: 167000, shield: 41000, armor: 10, speed: 0.38, bounty: 720, lives: 20, size: 0.95, cost: 0, intro: 0,
  ...
  E({ id: 'grand_antiprism', name: 'The Grand Antiprism', dim: 4, n: 320, poly: 'grand_antiprism', color: '#b0a0ff', hp: 21600, shield: 4900, speed: 0.42, bounty: 720, lives: 20, size: 0.95, cost: 0, intro: 0,
    tenacity: 0.3, traits: ['boss', 'shielded'],
